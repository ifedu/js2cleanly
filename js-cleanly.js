(function () {
    ...
    module.exports = function (fileOrigin, fileModified) {
        var fs = require('fs');

        fs.readFile(fileOrigin, 'utf-8', function(err, dataFile) {

            function writeTxt(lines) {
                var conditional;
                var is = {};
                var parenthesis = 0;
                var tab = '';
            ...
            fs.writeFile(fileModified, dataFile);
        });
    };
}());